...
import libs.AWSIoTPythonSDK.exception.operationTimeoutException as operationTimeoutException
import libs.AWSIoTPythonSDK.exception.operationError as operationError
