...
class CvEngine:
    ...
    def process_video(self, video_uri):
        ...
        while input_cap.isOpened() and self.running_video:
            ...
            for t in titles:
                cv.namedWindow(t)
            width = input_cap.get(cv.CAP_PROP_FRAME_WIDTH)
            height = input_cap.get(cv.CAP_PROP_FRAME_HEIGHT)

            fourcc = cv.VideoWriter_fourcc(*'DIVX')
            filename = 'post_processing1.mp4'

            out = cv.VideoWriter(filename, fourcc, fps, (int(width), int(height)))
            '''
            #
            #......................................................
            #
        ...
        for section in LOG_SECTIONS:
            if section == POST_PROCESSING:
                ...
                for p_processor in self.post_processors:
                    ...
                    #logger.info(f'>>>>>>>p_processor_name : {p_processor_name}')
            ...
            if self.last_log_time:
                ...
                if self.log_performance_directory:
                    ...
                    with open(file_path, "a") as csvfile:
                        ...
                        logger.info(f">>>>>>>>>>Timestamp, FPS csv file write")
