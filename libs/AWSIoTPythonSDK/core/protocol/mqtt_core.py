...
import libs.AWSIoTPythonSDK
from libs.AWSIoTPythonSDK.core.protocol.internal.clients import InternalAsyncMqttClient
from libs.AWSIoTPythonSDK.core.protocol.internal.clients import ClientStatusContainer
from libs.AWSIoTPythonSDK.core.protocol.internal.clients import ClientStatus
from libs.AWSIoTPythonSDK.core.protocol.internal.workers import EventProducer
from libs.AWSIoTPythonSDK.core.protocol.internal.workers import EventConsumer
from libs.AWSIoTPythonSDK.core.protocol.internal.workers import SubscriptionManager
from libs.AWSIoTPythonSDK.core.protocol.internal.workers import OfflineRequestsManager
from libs.AWSIoTPythonSDK.core.protocol.internal.requests import RequestTypes
from libs.AWSIoTPythonSDK.core.protocol.internal.requests import QueueableRequest
from libs.AWSIoTPythonSDK.core.protocol.internal.defaults import DEFAULT_CONNECT_DISCONNECT_TIMEOUT_SEC
from libs.AWSIoTPythonSDK.core.protocol.internal.defaults import DEFAULT_OPERATION_TIMEOUT_SEC
from libs.AWSIoTPythonSDK.core.protocol.internal.defaults import METRICS_PREFIX
from libs.AWSIoTPythonSDK.core.protocol.internal.defaults import ALPN_PROTCOLS
from libs.AWSIoTPythonSDK.core.protocol.internal.events import FixedEventMids
from libs.AWSIoTPythonSDK.core.protocol.paho.client import MQTT_ERR_SUCCESS
from libs.AWSIoTPythonSDK.exception.AWSIoTExceptions import connectError
from libs.AWSIoTPythonSDK.exception.AWSIoTExceptions import connectTimeoutException
from libs.AWSIoTPythonSDK.exception.AWSIoTExceptions import disconnectError
from libs.AWSIoTPythonSDK.exception.AWSIoTExceptions import disconnectTimeoutException
from libs.AWSIoTPythonSDK.exception.AWSIoTExceptions import publishError
from libs.AWSIoTPythonSDK.exception.AWSIoTExceptions import publishTimeoutException
from libs.AWSIoTPythonSDK.exception.AWSIoTExceptions import publishQueueFullException
from libs.AWSIoTPythonSDK.exception.AWSIoTExceptions import publishQueueDisabledException
from libs.AWSIoTPythonSDK.exception.AWSIoTExceptions import subscribeQueueFullException
from libs.AWSIoTPythonSDK.exception.AWSIoTExceptions import subscribeQueueDisabledException
from libs.AWSIoTPythonSDK.exception.AWSIoTExceptions import unsubscribeQueueFullException
from libs.AWSIoTPythonSDK.exception.AWSIoTExceptions import unsubscribeQueueDisabledException
from libs.AWSIoTPythonSDK.exception.AWSIoTExceptions import subscribeError
from libs.AWSIoTPythonSDK.exception.AWSIoTExceptions import subscribeTimeoutException
from libs.AWSIoTPythonSDK.exception.AWSIoTExceptions import unsubscribeError
from libs.AWSIoTPythonSDK.exception.AWSIoTExceptions import unsubscribeTimeoutException
from libs.AWSIoTPythonSDK.core.protocol.internal.queues import AppendResults
from libs.AWSIoTPythonSDK.core.util.enums import DropBehaviorTypes
from libs.AWSIoTPythonSDK.core.protocol.paho.client import MQTTv31
...
class MqttCore(object):
    ...
    def _load_username_password(self):
        ...
        if self._enable_metrics_collection:
            ...
            username_candidate += libs.AWSIoTPythonSDK.__version__
